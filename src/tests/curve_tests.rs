...
mod tests {
    ...
    fn test_curve_initialization() {
        let mut curve: Curve = Default::default();
    ...
    #[test]
    fn test_is_oob() {
        let mut my_curve: Curve = Default::default();
    ...
    fn test_integrate() {
        let mut my_curve: Curve = Default::default();
        let _ = my_curve.load_curve("test-data/curve_constant.csv").unwrap();
        let mut my_curve_2: Curve = Default::default();
    ...
    fn test_multiply_2() {
        let mut my_curve: Curve = Default::default();
        let _ = my_curve.load_curve("test-data/curve_constant.csv").unwrap();
        let mut my_curve_mult: Curve = Default::default();
    ...
    fn test_add_2() {
        let mut my_curve: Curve = Default::default();
        let _ = my_curve.load_curve("test-data/curve_constant.csv").unwrap();
        let mut my_curve_3: Curve = Default::default();
