...
mod tests {
    ...
    fn test_signal_crv() {
        ...
        //detector.set_detector("CCD231-84-0-S77");
        //detector.set_pixel_photon_flux(spectrum);
        //let _ = detector.get_signal_crv().get_curve().save_curve("test-data/curve_constant_signal.csv").unwrap();
        //assert!(detector.get_signal_crv().get_curve().get_point(NotNan::new(2.0).unwrap()) - 0.000000001125  > -0.000000001125);
        //assert!(detector.get_signal_crv().get_curve().get_point(NotNan::new(2.0).unwrap()) - 0.000000001125 < 1e-4);
    ...
    fn test_noise() {
        ...
        //detector.set_detector("CCD231-84-0-S77");
        //detector.set_pixel_photon_flux(spectrum);
        //let noise = detector.noise_px(NotNan::new(2.0).unwrap());
    ...
    fn test_snr() {
        ...
        //detector.set_detector("CCD231-84-0-S77");
        //detector.set_pixel_photon_flux(spectrum);
        //let noise = detector.snr_px(NotNan::new(2.0).unwrap());
